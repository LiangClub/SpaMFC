...
```bash
# 使用清华源安装
pip install SpaMFC -i https://pypi.tuna.tsinghua.edu.cn/simple
```
...
```bash
# 功能富集分析（使用清华源）
pip install gseapy>=1.0 -i https://pypi.tuna.tsinghua.edu.cn/simple

# CNV分析（恶性细胞）
pip install infercnvpy>=0.4 -i https://pypi.tuna.tsinghua.edu.cn/simple

# Excel报告生成
pip install openpyxl>=3.0 -i https://pypi.tuna.tsinghua.edu.cn/simple

# 安装所有可选依赖
pip install SpaMFC[all] -i https://pypi.tuna.tsinghua.edu.cn/simple
```
